...
describe('ConfigLoader', () => {
  ...
  describe('validate', () => {
    ...
    it('should throw error for invalid port', () => {
      ...
      expect(() => ConfigLoader.validate(config)).toThrow('Port must be between 0 and 65535');
    });
    ...
    it('should throw error for invalid storage type', () => {
      ...
      expect(() => ConfigLoader.validate(config)).toThrow('Invalid events storage type: invalid');
    });
    ...
    it('should throw error for invalid environment', () => {
      ...
      expect(() => ConfigLoader.validate(config)).toThrow('Invalid environment: invalid');
    });
  });
});