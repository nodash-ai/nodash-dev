...
class TestRunner {
  ...
  async runAll() {
    ...
    const integrationSuccess = await this.runCommand('npm', ['run', 'test:integration'], 'Integration Tests');
    ...
    const allSuccess = typecheckSuccess && buildSuccess && unitSuccess && integrationSuccess && e2eSuccess;
